...
#line 85 "DeskCalc.tab.c" /* yacc.c:339  */
...
union YYSTYPE
{
#line 21 "DeskCalc.y" /* yacc.c:355  */

	struct ast* a;
	double d;

#line 142 "DeskCalc.tab.c" /* yacc.c:355  */
};
...
#line 159 "DeskCalc.tab.c" /* yacc.c:358  */
...
{
  "$end", "error", "$undefined", "SUB", "ADD", "MUL", "DIV", "EXP", "ABS",
  "UM", "NUM", "EOL", "$accept", "calclist", "expr", "factor", "exponent",
  "term", YY_NULLPTR
};
#endif
...
{
      -8,     0,    -8,    -7,    -7,    -8,     1,    11,    -8,     4,
      -8,    -8,    -7,    -7,    -8,    -7,    -7,    -7,    11,    11,
      -8,    -8,    -8
};
...
{
       2,     0,     1,     0,     0,    12,     0,     4,     7,    10,
      14,    13,     0,     0,     3,     0,     0,     0,     6,     5,
       8,     9,    11
};
...
{
       2,     3,     4,     5,    12,    13,    18,    19,     3,     4,
       5,    17,    14,    20,    21,    22,    15,    16,    10,    11
};

static const yytype_uint8 yycheck[] =
{
       0,     8,     9,    10,     3,     4,    12,    13,     8,     9,
      10,     7,    11,    15,    16,    17,     5,     6,     3,     4
};
...
{
       0,    13,     0,     8,     9,    10,    14,    15,    16,    17,
      17,    17,     3,     4,    11,     5,     6,     7,    15,    15,
      16,    16,    16
};
...
#line 57 "DeskCalc.y" /* yacc.c:1906  */
